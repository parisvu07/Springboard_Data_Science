...
This is Tier 1 of the case study, which means that there'll be more guidance for you about how to set up your local SQLite connection in PART 2 of the case study. 
...
You'll need to paste your query into the value of the 'query1' variable and run the code block again to get an output.
...
/* Q11: Produce a report of members and who recommended them in alphabetical surname,first name order */
